...
function showCal() {
    const daynumber = today.getFullYear() + "年" + (today.getMonth() + 1) + "月" + today.getDate() + "日 " + d[today.getDay() + 1] + '<br>';
    let calendar = "<div class=\"calendar\">" + daynumber + GetLunarDay(yy, mm, dd) ;
    calendar=calendar+"<br>"+"<div id='clock'></div>"+ "</div>"
...
function ChangeClock() {
    ...
    if(second<10)
        second='0'+second;
    document.getElementById("clock").innerHTML = "当前时间："+ hour + ":" + minute + ":" + second;
